...
from .views import ListCategory, DetailCategory, UserRegisterationView, UserListView, UserDetailView, ListBookView, DetailBookView, ListCartView, DetailCartView, ListOrderView, DetailOrderView
