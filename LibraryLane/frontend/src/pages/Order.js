    ...
    <div className={css(styles.root)}>
      ...
      <div className={css(styles.contents)}>
            ...
            <div className={css(styles.detailBox)}>
                <div className={css(styles.top)}>
                    <div className={css(styles.contentsBox)}>
                        <div className={css(styles.title)}>Book: </div>
                ...
                <div className={css(styles.bottom)}>
                    ...
                    <input className={css(styles.inpf)} type='text'  placeholder='(House No, Building, Street, Area)' value={order.address} onChange={handleInputChange}></input>
                    <input className={css(styles.inpf)} type='text'  placeholder='pincode' value={order.pin_code} onChange={handleInputChange} ></input>
                    <input className={css(styles.button)} type='submit' value='Place Order' />
        ...
        <div className={css(styles.price)}>PRICE DETAILS</div>
            ...
            <div className={css(styles.prices)}>MRP : </div>
            ...
            <div className={css(styles.totalPrice)}>TOTAL AMOUNT : <b>$14</b></div>
        </div>
