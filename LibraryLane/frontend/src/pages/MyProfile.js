      ...
      <div className={css(styles.orderSec)}>
        ...
        <div className={css(styles.container)}>
            {orders.map((order) =>(
                ...
                <div className={css(styles.top)}> Order id: <b>{order.id}</b></div>
                <div className={css(styles.bottom)}>
                    <div className={css(styles.bookName)}>Book: <b>{order.books}</b> </div>
                    <div className={css(styles.status)}>Price: <b>{order.total_amount} </b></div>
                </div>
            </div>
                </div>
            ))}
